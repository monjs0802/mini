...
<div class="flex-shrink-0 p-3 bg-gradient">
    <a href="http://localhost:8080/omakaseProject/admin/adminSales" class="d-flex align-items-center link-dark pb-3 mb-3 text-decoration-none border-bottom">
      <svg class="bi pe-none me-2" width="30" height="24"><use xlink:href="#bootstrap"></use></svg>
      <span class="fs-5 fw-semibold text-center">ADMIN PAGE</span>
    </a>
    ...
    <ul class="list-unstyled ps-0">
      ...
      <c:if test="${sessionScope.memId == 'admin'}">
	      <li class="mb-1">
	        <button class="btn btn-toggle d-inline-flex align-items-center text-light rounded border-0 fw-bold collapsed" data-bs-toggle="collapse" data-bs-target="#admin-collapse" aria-expanded="false">
	          ADMIN PAGE
	        </button>

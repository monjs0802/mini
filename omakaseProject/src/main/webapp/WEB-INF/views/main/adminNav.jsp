...
<div class="flex-shrink-0 p-3 bg-gradient">
    ...
    <ul class="list-unstyled ps-0">
      ...
      <li class="mb-1">
        <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0 fw-bold text-light collapsed" data-bs-toggle="collapse" data-bs-target="#admin-collapse" aria-expanded="false">
          ADMIN PAGE
        </button>

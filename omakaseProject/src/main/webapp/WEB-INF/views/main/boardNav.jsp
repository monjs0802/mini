...
<div class="flex-shrink-0 p-3 bg-gradient">
    <a href="http://localhost:8080/omakaseProject//board/notice/noticeList?pg=1" class="d-flex align-items-center link-dark pb-3 mb-3 text-decoration-none border-bottom">
      <svg class="bi pe-none me-2" width="10" height="24"><use xlink:href="#bootstrap"></use></svg>

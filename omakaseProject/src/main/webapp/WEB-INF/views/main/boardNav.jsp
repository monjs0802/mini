...
<div class="flex-shrink-0 p-3">
    <a href="../board/noticeBoard" class="d-flex align-items-center pb-3 mb-3 link-dark text-decoration-none border-bottom">
      ...
      <li class="mb-1">
        ...
        <div class="collapse" id="account-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            ...
            <li><a href="#" class="link-dark d-inline-flex text-decoration-none rounded">메뉴 추가</a></li>
          </ul>
        </div>
      </li>
    </ul>
